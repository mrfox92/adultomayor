        ...
        <ul class="sidemenu-nav metisMenu h-100" id="sidemenu-nav" data-simplebar>
            ...
            <li class="nav-item">
                <a href="#" class="collapsed-nav-link nav-link" aria-expanded="false">
                    ...
                    <span class="menu-title">Registros agrupados</span>
                ...
                <ul class="sidemenu-nav-second-level">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('informacionam.index') }}" class="nav-link" aria-expanded="false">
                            <span class="icon"><i class='bx bx-data'></i></span>
                            <span class="menu-title">Registros adulto mayor</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a href="{{ route('informacionpsd.index') }}" class="nav-link" aria-expanded="false">
                            <span class="icon"><i class='bx bx-data'></i></span>
                            <span class="menu-title">Registros PSD</span>
                        </a>
                    </li>
